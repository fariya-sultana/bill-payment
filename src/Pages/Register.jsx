            ...
            <div className="card bg-white w-full max-w-sm shrink-0 shadow-2xl py-5" >
                ...
                <div className="card-body py-0">
                    <form onSubmit={handleRegister} className="fieldset">
                        ...
                        <button className='btn mt-2 hover:bg-secondary text-lg bg-primary text-base-200' >Register</button>

                        <p className='text-center text-secondary py-1 text-sm '>Already Have An Account? <Link className='font-bold text-secondary hover:underline' to={'/auth/login'}>Login</Link></p>
